...
import qualified Day_10.Solution as Day10
import qualified Day_11.Solution as Day11
...
tests = do
  ...
  describe "day 09 solutions" $ do
    ...
    it "solves second" $ do
      ...
      result `shouldBe` 2
  describe "day 10 solutions" $ do
    it "solves first" $ do
      result <- Day10.solveFirst "src/Day_10/test_input.txt"
      result `shouldBe` 8
    it "solves second" $ do
      result <- Day10.solveSecond "src/Day_10/test_input.txt"
      result `shouldBe` 1
  describe "day 11 solutions" $ do
    it "solves first" $ do
      result <- Day11.solveFirst "src/Day_11/test_input.txt"
      result `shouldBe` 374
    it "solves second" $ do
      result <- Day11.solveSecond "src/Day_11/test_input.txt"
      result `shouldBe` 1
